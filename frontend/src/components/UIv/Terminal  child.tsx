  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center p-4 pointer-events-none vt323-regular">
        <div className="terminal-container terminal-scanlines w-full max-w-4xl h-[500px] bg-black/90 border-2 border-green-500 rounded-lg shadow-[0_0_30px_rgba(0,255,65,0.5)] backdrop-blur-sm pointer-events-auto relative overflow-hidden">
            ...
            <div className="text-green-400 vt323-regular mt-10">
              ...
              <div className="w-full flex justify-center items-center -mt-10">
                <button
                  ...
                  className={`button-enter vt323-regular cursor-pointer bg-black text-green-400 font-mono py-2 px-8 border-2 border-green-500 uppercase tracking-widest transition-all duration-300 active:translate-y-1 button-glow button-hover-active ${
